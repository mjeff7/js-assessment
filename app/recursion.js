recursionAnswers = {
  ...
  listFiles: function listFiles(data, dirName) {
    return typeof dirName === 'undefined' || data.dirName === dirName
      ? data.files.concat(...data.subDirs.map(subDir => listFiles(subDir)))
      : [].concat(...data.subDirs.map(subDir => listFiles(subDir, dirName)));
  },
