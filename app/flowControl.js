flowControlAnswers = {
  ...
  fizzBuzz: function fizzBuzz(num) {
    ...
    // Note: Remove the else keywords if brevity is preferred to return symmetry
    // in conditionals. Last else omitted because of linter settings.

    // Alternatively, use single return form:
